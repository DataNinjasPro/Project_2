...
d3.csv("data.csv", function(error, smurfData) {
  ...
  // Scale the domain
  xTimeScale.domain(d3.extent(smurfData, function(data) {
    return data.date;
  }));
  yLinearScale1.domain([d3.min(smurfData, function(data) {
    return data.dow_index;
  }), d3.max(smurfData, function(data) {
    return data.dow_index;
  })]);
  yLinearScale2.domain([d3.min(smurfData, function(data) {
